(() => {
  ...
  /* =========================
     CONFIG: Assets in /root-rise/ folder
     ========================= */
  const ASSETS = {
    bg: "bg-01.png",
    plants: {
  ...
  const PLANTS = [
    { id:"albino-syngonium", name:"Albino Syngonium Arrow", imageKey:"albino-syngonium", countLabel:"", careIntervalDays:7,
    ...
    { id:"prayer-plant", name:"Prayer Plant", imageKey:"prayer-plant", countLabel:"", careIntervalDays:6,
    ...
    { id:"pothos", name:"Pothos", imageKey:"pothos", countLabel:"(x6)", careIntervalDays:10,
    ...
    { id:"snake-plant", name:"Snake Plant", imageKey:"snake-plant", countLabel:"(x2)", careIntervalDays:21,
    ...
    { id:"cactus", name:"Cactus", imageKey:"cactus", countLabel:"", careIntervalDays:28,
    ...
    { id:"tiny-cactus", name:"Tiny Cacti", imageKey:"tiny-cactus", countLabel:"(x4)", careIntervalDays:21,
      careType:"Water (sparingly; fully dry)",
    ...
    { id:"monstera", name:"Monstera", imageKey:"monstera", countLabel:"", careIntervalDays:10,
  ...
  const GROUNDING_ACTIONS = [
    ...
    "Watch the flame for one minute.",
  ...
  ].slice(0, 45).map(a => `Light a candle. ${a}`);
  ...
  function plantImageFile(plant) {
    // simple fallback for tiny-cactus
    if (plant.imageKey === "tiny-cactus" && !ASSETS.plants["tiny-cactus"]) return ASSETS.plants.cactus;
  ...
  function seedEmbers(container, count) {
    container.innerHTML = "";
    const n = Math.max(10, Math.min(22, count)); // more embers for prominence
    ...
    for (let i = 0; i < n; i++) {
      ...
      const dur = 1.4 + Math.random() * 2.1;
      const size = 2.5 + Math.random() * 4.4;
      const drift = (Math.random() * 54) - 27;
  ...
  function renderDaily() {
    ...
    // Always set text (no-op if elements missing)
